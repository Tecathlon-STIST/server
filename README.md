...
> This is the central backbone of our project, taking care of all the active users & vehicles on a daily basis! We take it pretty seriously, and so should you 😜
...
10. ### Retrieving logs (overall stats)
    ...
    * Returns: a JSON object with the aggregated vehicle stats & report since it was initially connected
